...
import org.saddle._
import org.saddle.io.CsvImplicits


object AppendList extends{
  def main(args: Array[String]) {
    ...
    //saddle Frame: http://stackoverflow.com/questions/20293014/concatenating-saddle-series-into-one-frame
    ...
    //write csv
    val f2csvWriter = CsvImplicits.frame2CsvWriter(f)
    f2csvWriter.writeCsvFile("/Volumes/jetD_YD/ScalaProject/lotteryCrawler/output/f.csv")
  }
}
